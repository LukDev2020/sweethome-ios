...
exports.getTwimlLanguage = getTwimlLanguage;
 ...
 */
function getTwimlLanguage(countryCode) {
    const map = {
        CN: "zh-CN",
        US: "en-US",
        CA: "en-US",
 ...
 */
async function initiateVoiceCall(guardianId, sosEventId, protectedPersonName, callbackUrl) {

...
export const PLANS = {
  free: {
    ...
    features: ["basic_sos", "1_guardian", "24h_timeline"],
  },
  guardian_team: {
    id: "guardian_team",
    name: "守护团队",
    price: 28,
    appleProductId: "app.shoudeng.guardian_team.monthly",
    ttlDays: { heartbeat: 90, location: 90, checkin: -1 },
    features: ["unlimited_guardians", "90d_timeline", "duty_schedule", "export_pdf"],
  },
  pro_response: {
    id: "pro_response",
    name: "专业响应",
    price: 98,
    appleProductId: "app.shoudeng.pro_response.monthly",
    ttlDays: { heartbeat: 90, location: 90, checkin: -1 },
    features: ["voice_call_escalation", "sms_fallback", "priority_support"],
  },
  family_bundle: {
    id: "family_bundle",
    name: "全家套餐",
    price: 288,
    appleProductId: "app.shoudeng.family_bundle.monthly",
    ttlDays: { heartbeat: 90, location: 90, checkin: -1 },
    features: ["all_pro_features", "up_to_4_protected", "family_dashboard"],
  },
} as const;
